/*
Distributed computing in Go with Oracle Grid Engine.

The design pattern of this library is to write a program which, when invoked in "master" mode, submits a Grid Engine job executing itself in "slave" mode. For example:
	package main
